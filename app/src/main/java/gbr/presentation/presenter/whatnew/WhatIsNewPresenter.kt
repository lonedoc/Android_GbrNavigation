...
class WhatIsNewPresenter:MvpPresenter<WhatIsNewView>() {
    override fun onFirstViewAttach() {
        ...
        val changes = "#### Изменения: \n" +
                "* Иконка приложения \n" +
                "* Графический стиль некоторых элементов приложения \n" +
                "* Можно задавать собственный imei для входа (только численные значения)"
        ...
        val fix:String = "#### Исправлено: \n" +
                "* При перевороте экрана больше не сбрасывается месторасположение"
